...
app.get('/send', function (req, res) {
    var ses_mail = "From: 'AWS Tutorial' <" + email + ">\n";
    ses_mail = ses_mail + "To: " + email + "\n";
    ses_mail = ses_mail + "Subject: AWS Attachment Example\n";
    ...
    ses_mail = ses_mail + "AWS Tutorial File Attachment!" + "\n\n";
    ses_mail = ses_mail + "--NextPart--";
...
var server = app.listen(80, function () {
    ...
    console.log('AWS example app listening at http://%s:%s', host, port);
});
